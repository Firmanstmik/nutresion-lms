    ...
    <div class="sp-header">
        ...
        <div class="sp-header-left">
            ...
            <p class="sp-header-sub">
                Buat, edit, dan hapus pertanyaan untuk pre test kursus ini.
            </p>
                ...
                <tr>
                    ...
                    <td class="sp-td sp-td-actions">
                        <div class="sp-actions-group">
                            ...
                            <form action="{{ route('admin.pre_questions.destroy', $question->id) }}" method="POST"
...
<div id="addModal" class="sp-modal-backdrop hidden">
    <div class="sp-modal">
        ...
        <div class="sp-modal-body">
            <form action="{{ route('admin.pre_questions.store', $course->id) }}" method="POST" id="addForm">
                @csrf
                <div class="sp-field">
